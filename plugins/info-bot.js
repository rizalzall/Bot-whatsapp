...
await conn.sendMessage(m.chat, {text: loadd[i], edit: key })}
  ...
  let mentionedJid = [m.sender]
    ...
    let sts = ` – *ɪɴғᴏ ʙᴏᴛ ғuʀɪɴᴀ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ*
...
seconds: 18,
fileLength: 18,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ғᴜʀɪɴᴀ - ᴀɪ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: 'ʙᴏᴛ ʙʏ ᴋʏᴢ', sourceUrl: 'https://whatsapp.com/channel/0029VaRI1OB2P59cTdJKZh3q', thumbnail: await (await fetch(thumb)).buffer(),}}  
  }) 
}
